...
const emailOrPasswordEmptyDescription =
    'You seem to have forgotten to enter either email or password field, or both. Please....';
const loginErrorDialogTitle = 'Login Error';
const loginErrorDialogContent =
    'Invalid email/password combiation. Please try again with valid credentials.';
